          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header d-flex justify-content-between">
                ...
                <button class="btn btn-primary" id="btn-Tambah-meja" data-toggle="modal" data-target="#exampleModalCenter"> <i class="fas fa-plus"></i> Tambah meja</button>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="d-flex justify-content-center">
                          <a href="{{ route('meja.edit', $meja->id) }}" class="btn btn-sm btn-primary mr-2 mb-2">
                            Edit
                          </a>
